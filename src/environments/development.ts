...
const appRoute: string =
  process.env.APP_ROUTE ?? `${prefixHttps}://${appHost}:${appPort}`;
...
const dbUser: string = process.env.DB_USERNAME ?? 'admin';
const dbPassword: string = process.env.DB_PASSWORD;
const dbDatabase: string = process.env.DB_DATABASE ?? 'celerik_dev';
...
const adminEmail: string = process.env.ADMIN_EMAIL ?? 'user@celerik.com';
